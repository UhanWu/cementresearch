...
data_filtered <- combinedata2 |>
  select(!c(year, gasppi, silica, lime))

# Perform stepwise regression on the filtered data
stepwise_model <- lm(Cement ~ unemploy + gdp + workers + limestone + housing, data = data_filtered)
